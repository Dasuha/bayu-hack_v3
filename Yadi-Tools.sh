...
toilet -f big -F gay "Yadi"
sleep 1
echo $yellow "Kalau ngga bisa, mungkin udah expired bro"
sleep 2
echo
echo $green "Minta yang baru ke 085706249638"
sleep 3
echo
apt update 
apt upgrade
...
sleep 1
echo
echo $yellow "Sebelum install pastikan lu udah punya akun fb tumbal"
sleep 3
echo
echo $green "Untuk password memang tidak terlihat"
sleep 2
echo
echo $blue "Jadi saat lu ketik password perhatiin keyboard nya biar ngga salah"
sleep 3
echo
echo $green "OKE SELAMAT MENGINSTALL DAN MENGGUNAKAN :)"
sleep 4
pkg update && pkg upgrade
pkg install python2
pkg install git
